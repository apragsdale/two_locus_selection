...
%Finally, I discuss how well
%we can expect to discriminate between modes of selective interactions using
...
%The effects of non-additive selection within a locus and interference has received
%less attention. \citet{Garcia2020-zn} used large-scale forward simulations to explore
...
%\caption{\textbf{LD within and between protein-coding genes.} FIXME (A-B) Pairs of
...
%\textbf{LD within and between annotated domains in protein-coding
...
%populations analyzed here isshown in Figure \ref{fig:domainspops}.}\label{fig:LDdata}
%\end{figure}
