...
t, v = get_sd1(nus_expand, Ts_expand, 50, gamma=-2.0, name="expand")
axes[1].plot(t, v, "-", lw=lw, color=colors[0])
t, v = get_sd1(nus_bottle, Ts_bottle, 50, gamma=-2.0, name="bottle")
axes[1].plot(t, v, "--", lw=lw, color=colors[1])
axes[1].text(1000, v[0] + 0.02, rf"$\gamma=-2$", va="center", ha="center", fontsize=7)
...
t, v = get_sd1(nus_expand, Ts_expand, 50, gamma=-2.0, h=0.1, name="expand")
axes[2].plot(t, v, "-", lw=lw, color=colors[0])
t, v = get_sd1(nus_bottle, Ts_bottle, 50, gamma=-2.0, h=0.1, name="bottle")
axes[2].plot(t, v, "--", lw=lw, color=colors[1])
axes[2].text(1000, v[0] + 0.06, rf"$\gamma=-2$", va="center", ha="center", fontsize=7)
...
# gamma = -2
t, v = get_sd1(nus_expand, Ts_expand, 50, gamma=-2.0, h=0.1, dom="gene", name="expand")
axes[3].plot(t, v, "-", lw=lw, color=colors[0])
t, v = get_sd1(nus_bottle, Ts_bottle, 50, gamma=-2.0, h=0.1, dom="gene", name="bottle")
axes[3].plot(t, v, "--", lw=lw, color=colors[1])
axes[3].text(1000, v[0] + 0.08, rf"$\gamma=-2$", va="center", ha="center", fontsize=7)
...
thr = 4
# each with gamma = -2
t, v = get_sd1_cond(gamma=-2.0, name="expand", nAmax=thr, nBmax=thr)
axes[4].plot(t, v, "-", lw=lw, color=colors[0])
t, v = get_sd1_cond(gamma=-2.0, name="bottle", nAmax=thr, nBmax=thr)
axes[4].plot(t, v, "--", lw=lw, color=colors[1])
axes[4].text(600, v[0] - 0.7, rf"$h=1/2$", va="center", ha="center", fontsize=7)
# site-wise
t, v = get_sd1_cond(gamma=-2.0, h=0.1, name="expand", nAmax=thr, nBmax=thr)
axes[4].plot(t, v, "-", lw=lw, color=colors[0])
t, v = get_sd1_cond(gamma=-2.0, h=0.1, name="bottle", nAmax=thr, nBmax=thr)
axes[4].plot(t, v, "--", lw=lw, color=colors[1])
axes[4].text(600, v[0] - 0.4, rf"site", va="center", ha="center", fontsize=7)
# gene-based
t, v = get_sd1_cond(gamma=-2.0, h=0.1, dom="gene", name="expand", nAmax=thr, nBmax=thr)
axes[4].plot(t, v, "-", lw=lw, color=colors[0])
t, v = get_sd1_cond(gamma=-2.0, h=0.1, dom="gene", name="bottle", nAmax=thr, nBmax=thr)
axes[4].plot(t, v, "--", lw=lw, color=colors[1])
axes[4].text(800, v[0] + 0.6, rf"gene", va="center", ha="center", fontsize=7)
# neutral baseline
t, v = get_sd1_cond(nAmax=thr, nBmax=thr, name="expand")
axes[4].plot(t, v, "k--", lw=0.5)
t, v = get_sd1_cond(nAmax=thr, nBmax=thr, name="bottle")
axes[4].plot(t, v, "k--", lw=0.5)
...
# each with gamma = -1
t, v = get_sd1_cond(gamma=-2.0, name="expand", nAmin=thr + 1, nBmin=thr + 1)
axes[5].plot(t, v, "-", lw=lw, color=colors[0])
t, v = get_sd1_cond(gamma=-2.0, name="bottle", nAmin=thr + 1, nBmin=thr + 1)
axes[5].plot(t, v, "--", lw=lw, color=colors[1])
axes[5].text(1000, v[0] + 0.15, rf"$h=1/2$", va="center", ha="center", fontsize=7)
# site-wise
t, v = get_sd1_cond(gamma=-2.0, h=0.1, name="expand", nAmin=thr + 1, nBmin=thr + 1)
axes[5].plot(t, v, "-", lw=lw, color=colors[0])
t, v = get_sd1_cond(gamma=-2.0, h=0.1, name="bottle", nAmin=thr + 1, nBmin=thr + 1)
axes[5].plot(t, v, "--", lw=lw, color=colors[1])
axes[5].text(1000, v[0] + 0.1, rf"$h=0.1$, site", va="center", ha="center", fontsize=7)
# gene-based
t, v = get_sd1_cond(
...
axes[5].plot(t, v, "--", lw=lw, color=colors[1])
axes[5].text(1000, v[0] - 0.25, rf"$h=0.1$, gene", va="center", ha="center", fontsize=7)
# neutral baseline
t, v = get_sd1_cond(nAmin=thr + 1, nBmin=thr + 1, name="expand")
axes[5].plot(t, v, "k--", lw=0.5)
t, v = get_sd1_cond(nAmin=thr + 1, nBmin=thr + 1, name="bottle")
axes[5].plot(t, v, "k--", lw=0.5)

axes[5].set_title(rf"$n_A, n_B \geq {thr + 1}$ and $\gamma=-2$")
...
plt.savefig("demog_bottle_expand.dominance.pdf")
