...
many cases it is simpler to visualize summaries such as the expectation or
...
magnitude of the selection and dominance coefficients in a nonlinear way, but
note that expensive large-scale simulations are needed to explore these effects
as no closed form approach to computing those expectations exist. The method
presented here provides such a closed form approach, so that expectations of
signed LD and other two-locus statistics can be computed more efficiently and
accurately.
